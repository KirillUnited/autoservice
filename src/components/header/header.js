  ...
  return (
    <header id="site-header" className="header" role="banner">
      <div className="container flex flex-wrap justify-between relative">
        ...
        <div className="hidden basis-full md:basis-1/4 md:flex flex-col items-center justify-center p-2">
        ...
        <div className="basis-full md:basis-1/4 flex flex-col md:items-end justify-center p-2">
          <a className="font-semibold mb-2" href="tel:+375 29 372 63 65">+375 29 372 63 65</a>
          <a className="font-semibold mb-2" href="tel:+375 29 872 63 65">+375 29 872 63 65</a>
